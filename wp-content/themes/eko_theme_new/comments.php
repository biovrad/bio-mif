...
<h2 id="comments"><?php comments_number(__('No Comments'), __('1 Comment'), __('% Кометария(ев)')); ?>
...
?> 	
<p>
	<label for="mcspvalue"><small>Заполните поле результатом сложения  <?php echo $mcsp_info['operand1'] . ' + ' . $mcsp_info['operand2'] . ' ?' ?></small></label>
