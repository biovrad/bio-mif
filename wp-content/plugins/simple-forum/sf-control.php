<?php
/*
Plugin Name: Forum for Si
Version: 1.1
Plugin URI: 
Description: Простой форум на странице cайта каферды.
Author: Паша & Andy Staines 
Author URI:
...
{
	add_submenu_page('edit.php', __('Форум', 'sforum'), __('Форум', 'sforum'), 8, 'simple-forum/sf-admin.php');
}
