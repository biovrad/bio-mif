...
<?php fs_e('System diagnostics page') ?>: <button class="button" onclick="FS.openWindow('<?php echo fs_url("bridge.php?file_id=system_test")?>',800,800)"><?php fs_e('Open')?></button>
<br/>
<br/>
<table border="1">
  <tr>
...
<table>
  <tr>
    ...
    <td><button class="button" id="rebuild_countries_button" onclick="FS.executeProcess('rebuild_countries','php/ip2country.php')"><?php fs_e("Start")?></button></td>
    <td><span id="rebuild_countries_process_progress"></span></td>
  </tr>
  <tr>
    <td><?php fs_e('Rebuild database cache')." : "?></td>
    <td><button class="button" id="rebuild_cache_button" onclick="FS.executeProcess('rebuild_cache','php/rebuild-db.php')"><?php echo fs_r("Start")?></button></td>
    <td><span id="rebuild_cache_process_progress"></span></td>
  </tr>
  <tr>
    <td><?php fs_e('Recalculate search engine terms')." : "?></td>
    <td><button class="button" id="recalculate_search_engine_terms_button" onclick="FS.executeProcess('recalculate_search_engine_terms','php/searchengines.php')"><?php echo fs_r("Start")?></button></td>
