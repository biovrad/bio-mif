...
// increase post popularity
						...
						<dd>
							...
							<ul>
								...
								<li><code>
									...
									&lt;li>&lt;h2>Самое популярное в \'&lt;?php single_cat_title(); ?>\'&lt;/h2><br />
									&nbsp;&nbsp;	&lt;ul><br />
						...
						<dd>
							...
							<ul>
								...
								<li><code>
									...
									&lt;li>&lt;h2>Самое популярное в &lt;?php the_time(\'F, Y\'); ?>&lt;/h2><br />
									&nbsp;&nbsp;	&lt;ul><br />
	...
	function show_report_extended($type = 'popular', $limit = 50) {
		global $wpdb, $post;
		$columns = array(
			'popularity' => __('Popularity', 'alexking.org')
			,'title'      => __('Title', 'alexking.org')
			,'categories' => __('Categories', 'alexking.org')
			...
			,'comments'     => __('Com', 'alexking.org')
			,'pingbacks'     => __('Ping', 'alexking.org')
			,'trackbacks'     => __('Track', 'alexking.org')
		);
?>
...
<?php
	...
	function view_stats($limit = 100) {
		...
		print('
				<p id="akpc_options_link"><a href="options-general.php?page=popularity-contest.php">Изменить значения популярности</a></p>
