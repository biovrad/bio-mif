...
function wpsb_show_form($rtn = 0) {	
	...
	if ($add_link_lv) {
		$out .= "Get this <a href=\"http://www.sendblaster.com/wordpress-newsletter-double-optin-widget/\" title=\"Wordpress newsletter plugin\">wordpress newsletter plugin</a> and free <a href=\"http://www.sendblaster.com\" title=\"bulk email software\">bulk email software</a>";
	}
	if ($rtn) {
		return $out;
	}
    ...
    <table width="100%" cellspacing="2" cellpadding="5" class="optiontable editform">
      ...
      <tr valign="top"> 
        ...
        <td> 
          ...
          on confirmation link inside confirmation email.</td>
      </tr>
      <tr valign="top"> 
      ...
      <tr valign="top">
        ...
        <td>
          ...
          ony if you download your suscriptions daily)</td>
      </tr>
      <tr valign="top"> 
        <td colspan="2">&nbsp;</td>
      </tr>
