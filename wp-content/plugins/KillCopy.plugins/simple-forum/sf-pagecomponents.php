...
{
	$out = '<div id="sfversion"><a href="http://www.yellowswordfish.com">'.__("Simple Forum", "sforum").'</a> - '.__("Version", "sforum").' '.SFVERSION.' (Build '.SFBUILD.')'.sf_acknowledgements().'</div><br />'."\n";
	return $out;
}
...
function sf_acknowledgements()
{
	...
	$out.= '<p>'.__("Simple Forum WordPress Plugin created by Andy Staines: ", "sforum").'<strong><a href="http://www.stuff.yellowswordfish.com">Yellow Swordfish</a></strong></p>'."\n";
